...
async function run() {
    try {
        ...
        app.put(`/user/:id`, async (req, res) => {
            ...
            const updateDoc = {
                $set: {
                    name: updatedUser.name, email: updatedUser.email, gender: updatedUser.gender
                },
            };
